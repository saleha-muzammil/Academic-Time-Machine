...
int main(void)
{
        ...
        char My_msg[2000] = "Hello I am Client. My received id is ";
        ...
        //Send the message to the Server and receive from Server
        while(1)
        {
		...
		My_msg[strlen(My_msg)] = server_message[strlen(server_message)-1];
