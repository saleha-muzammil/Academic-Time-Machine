...
int main(void)
{
	...
	if(strlen(client_message)>1 || client_message[0]<'0' || 			client_message[0]>'9'){
		
		printf("INVALID ID. ID should be 0-9.\n");
		return -1;
	...
	char toSend[50];
	strcat(toSend,"Hello I am client and my ID is ");
	strcat(toSend,client_message);
